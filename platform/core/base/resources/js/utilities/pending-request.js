...
class PendingRequest {
    ...
    withButtonLoading(element) {
        this.beforeSend(() => Bng.showButtonLoading(element));
        this.completed(() => Bng.hideButtonLoading(element));

        return this;
    }

    withLoading(element) {
        this.beforeSend(() => Bng.showLoading(element));
        this.completed(() => Bng.hideLoading(element));
