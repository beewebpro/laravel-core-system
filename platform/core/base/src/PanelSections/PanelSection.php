...
namespace Bng\Base\PanelSections;

use Bng\Acp\Contracts\HasPermissions;
use Bng\Base\Contracts\PanelSections\PanelSection as PanelSectionContract;
use Bng\Base\Contracts\PanelSections\PanelSectionItem as PanelSectionItemContract;
use Bng\Base\Events\PanelSectionItemsRendered;
use Bng\Base\Events\PanelSectionItemsRendering;
use Bng\Base\Events\PanelSectionRendered;
use Bng\Base\Events\PanelSectionRendering;
...
class PanelSection implements PanelSectionContract
{
    ...
    protected string $view = 'core/base::system.group-panel';

    protected string $emptyStateView = 'core/base::system.empty';
