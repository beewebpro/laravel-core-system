...
use Bng\Base\Facades\DashboardMenu as DashboardMenuFacade;
use Bng\Base\Facades\PageTitle as PageTitleFacade;
...
class Breadcrumb implements Htmlable
{
    ...
    protected string $view = 'core/base::layouts.partials.breadcrumbs';
