...
namespace Bng\Base\Http\Responses;
...
class BaseHttpResponse extends Response implements Responsable
{
  ...
  public function withCreatedSuccessMessage(): static
  {
    return $this->setMessage(
      trans('core/base::base.create_success_message')
    );
  }
  ...
  {
    return $this->setMessage(
      trans('core/base::base.update_success_message')
    );
  }
  ...
  {
    return $this->setMessage(
      trans('core/base::base.delete_success_message')
    );
  }
