class TableFilter {
    ...
    $table = this.$filterForm.closest(".card-body").find("table");
    ...
    init() {
        ...
        this.$filterForm
            ...
            .on("click", ".btn-apply", (event) => {
                ...
                this.$filterForm
                    .find('[data-bb-toggle="datatable-reset-filter"]')
                    .show();
                ...
                $.each(data, (index, item) => {
                    ...
                    if (typeof keyName === "string" && keyName.endsWith("[]")) {
                        let keyValue = (paramsKey[keyName] =
                            paramsKey[keyName] || 0);

                        params.set(
                            `${keyName.replace("[]", `[${keyValue}]`)}`,
                            item.value
                        );
            ...
            .on(
                ...
                (event) => {
                    ...
                    this.$filterForm
                        .find(".form-filter:not(.filter-item-default)")
                        .remove();
                    this.$filterForm
                        .find(".filter-item")
                        .find(".filter-column-key")
