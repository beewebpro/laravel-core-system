...
namespace Bng\Table\Abstracts\Concerns;
...
{
    /**
     * @var \Bng\Table\Abstracts\TableActionAbstract[] $actions
     */
    ...
    /**
     * @param \Bng\Table\Abstracts\TableActionAbstract[] $actions
     */
    ...
    /**
     * @param \Closure(\Bng\Table\Abstracts\TableActionAbstract $action): \Bng\Table\Abstracts\TableActionAbstract $callback
     */
    ...
    public function getOperationsHeading()
    {
        return [
            Column::make('operations')
                ->title(trans('core/base::base.table.operations'))
                ->nowrap()
                ->alignCenter()
                ->orderable(false)
                ->searchable(false)
